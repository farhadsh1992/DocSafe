dataset_paths = {
	'cars_train': '/media/ssd2_data/Farhad_Sirin_ssd2/DATASETS/IMM_face/',
	'cars_test': '/media/ssd2_data/Farhad_Sirin_ssd2/DATASETS/IMM_face/',

	'celeba_train': '/media/ssd2_data/Farhad_Sirin_ssd2/DATASETS/IMM_face/',
	'celeba_test': '/media/ssd2_data/Farhad_Sirin_ssd2/DATASETS/IMM_face/',
	'celeba_test_w_inv': '',
	'celeba_test_w_latents': '',

	'ffhq': '/media/ssd2_data/Farhad_Sirin_ssd2/DATASETS/IMM_face/',
	'ffhq_w_inv': '',
	'ffhq_w_latents': '',

	'afhq_wild_train': '/media/ssd2_data/Farhad_Sirin_ssd2/DATASETS/IMM_face/',
	'afhq_wild_test': '/media/ssd2_data/Farhad_Sirin_ssd2/DATASETS/IMM_face/',

}

# dataset_paths = {
#     'train_data': '/media/ssd2_data/Farhad_Sirin_ssd2/DATASETS/IMM_face/',
#     'test_data': '/media/ssd2_data/Farhad_Sirin_ssd2/DATASETS/IMM_face/',
# }
model_paths = {
