...
from DocSafe.loss_functions_lib.models.encoders.psp import pSp
from DocSafe.loss_functions_lib.models.stylegan2.model import Generator
from configs.paths_config import model_paths
from DocSafe.loss_functions_lib.models.hypernetworks.hypernetwork import SharedWeightsHyperNetResNet, SharedWeightsHyperNetResNetSeparable
...
class HyperStyle(nn.Module):
    ...
    def __init__(self, opts):
        ...
        self.StyleGAN2 = Generator(self.opts.output_size, 512, 8, channel_multiplier=2)
    ...
    def load_weights(self):
        if self.opts.checkpoint_path is not None:
            ...
            self.StyleGAN2.load_state_dict(self.__get_keys(ckpt, 'decoder'), strict=True)
            ...
            self.StyleGAN2.load_state_dict(ckpt['g_ema'], strict=True)
            self.__load_latent_avg(ckpt, repeat=self.n_styles)
            if self.opts.load_w_encoder:
                self.w_encoder = self.__get_pretrained_w_encoder()
    def load_weights_hypernet(self):
        pass
    def load_weights_StyleGAN(self):
        pass
    ...
    def forward(self, x, resize=True, input_code=False, randomize_noise=True, return_latents=False,
        ...
        images, result_latent = self.StyleGAN2([codes],
